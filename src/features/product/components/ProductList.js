...
import { ChevronDownIcon, ChevronLeftIcon, StarIcon, ChevronRightIcon, FunnelIcon, MinusIcon, PlusIcon, Squares2X2Icon } from '@heroicons/react/20/solid'
                        ...
                        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            ...
                            <section aria-labelledby="products-heading" className="pb-24 pt-6">
                                ...
                                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                                    ...
                                    {/* Product grid */}
                                    <div className="lg:col-span-3">{/* This is product List */}
                                        <div className="bg-white">
                                                                ...
                                                                <div className="mt-4 flex justify-between">
                                                                    <div>
                                                                        ...
                                                                        <p className="mt-1 text-sm text-gray-500">
                                                                            <StarIcon className='w-6 h-6 inline mr-2 text-yellow-400' />
